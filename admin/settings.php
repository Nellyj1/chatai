...
if (isset($_POST['submit']) && wp_verify_nonce($_POST['aipc_settings_nonce'], 'aipc_save_settings')) {
    ...
    if ($is_license_active) {
        ...
        update_option('aipc_quick_action_primary_color', sanitize_hex_color($_POST['aipc_quick_action_primary_color'] ?? '#6366f1'));
        update_option('aipc_quick_action_secondary_color', sanitize_hex_color($_POST['aipc_quick_action_secondary_color'] ?? '#8b5cf6'));
                        ...
                        <td>
                            <div class="aipc-color-settings">
                                <div class="aipc-color-grid">
                                    ...
                                    <div class="aipc-color-item">
                                        <label for="aipc_quick_action_primary_color"><?php _e('FAQ/Quiz primair', 'ai-product-chatbot'); ?></label>
                                        <input type="color" id="aipc_quick_action_primary_color" name="aipc_quick_action_primary_color" 
                                               value="<?php echo esc_attr($quick_action_primary); ?>" />
                                        <small><?php _e('Primaire kleur voor FAQ/Quiz knoppen', 'ai-product-chatbot'); ?></small>
                                    </div>
                                    
                                    <div class="aipc-color-item">
                                        <label for="aipc_quick_action_secondary_color"><?php _e('FAQ/Quiz secundair', 'ai-product-chatbot'); ?></label>
                                        <input type="color" id="aipc_quick_action_secondary_color" name="aipc_quick_action_secondary_color" 
                                               value="<?php echo esc_attr($quick_action_secondary); ?>" />
                                        <small><?php _e('Secundaire kleur voor FAQ/Quiz knoppen gradient', 'ai-product-chatbot'); ?></small>
                                    </div>
                                </div>
